"""removing nullage=true

Revision ID: 49fcbc52a0a5
Revises: 1ee2349a0b49
Create Date: 2023-03-27 19:40:03.073484
...
revision = '49fcbc52a0a5'
down_revision = '1ee2349a0b49'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('user_profile_picture', sa.LargeBinary(), nullable=True),
    ...
    sa.Column('contract_date_creation', sa.Date(), nullable=False),
    sa.Column('contract_popularity', sa.Integer(), nullable=True),
