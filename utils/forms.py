...
class AddContractForm(FlaskForm):
    ...
    category_choices = ["Electricité", "Gaz", "Téléphone", "Internet", "Assurance animal", "Assurance Auto", "Assurance Maison"]
    
    category = SelectField('Field name', choices = category_choices, validators = [DataRequired()])
